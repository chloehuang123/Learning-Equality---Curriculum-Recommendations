...
# %%
import os
os.environ["KMP_DUPLICATE_LIB_OK"]="TRUE" # jupyter env set up
...
os.environ["TOKENIZERS_PARALLELISM"]="false" # tokens in parallel
os.environ["TRANSFORMERS_NO_ADVISORY_WARNINGS"]="true" # Turn off performance warnings
